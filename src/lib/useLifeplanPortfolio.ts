...
//
// Row-building + filtering live in lifeplan-aggregate.ts (shared with the
// scale-first Overview hooks). Types are re-exported here so existing consumers
...
export type { PortfolioRow, PortfolioFilters, ComplianceBucket };
